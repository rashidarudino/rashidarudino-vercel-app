...
export function House(props) {
  ...
  useFrame(() => {
    const targetScrollPosition = scroll.offset * tl.current.duration();
    scrollPosition.current = lerp(
      scrollPosition.current,
      targetScrollPosition,
      0.1
    );
    tl.current.seek(scrollPosition.current); // Seek the timeline smoothly
  });
